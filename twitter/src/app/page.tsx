    ...
    <main className="min-h-screen flex flex-col lg:flex-row items-center gap-20 p-10 lg:p-0">
      ...
      <div className="flex flex-col text-left gap-4">
        ...
        <div className="w-2/3 flex flex-col gap-4 text-center">
          <Button className="flex items-center justify-center gap-3 border rounded-full w-full border-black py-2">
          ...
          <p>または</p>
          <Button className="flex items-center justify-center gap-3 border rounded-full w-full border-black py-2">アカウントを作成</Button>
        </div>
      </div>
    </main>
  );
